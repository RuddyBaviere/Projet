    ...
    return (
        <div className="absolute top-full left-0 right-0 -mx-3 md:-mx-5 bg-slate-900 z-50 flex flex-col gap-10 pt-12 min-h-screen p-3 text-base">
            <div className="flex flex-col gap-3">
                <Button icon={<DiamondPlus/>} text="Vider sa soute" to="/" fullWidth className="flex justify-center"/>
                <Button outline text="Établir la liaison" to="/" fullWidth className="flex justify-center"/>
            </div>
