        ...
        <div className="flex justify-center items-center">
          <Formulaire>
            ...
            <div className="flex gap-4 w-full justify-between">
              <button className="grid justify-center bg-slate-700 p-2 rounded-lg border border-slate-400 w-1/2 cursor-pointer">
                <img src="./googleLogo.svg" alt="Logo de google" />
              </button>
              <button className="grid justify-center bg-slate-700 p-2 rounded-lg border border-slate-400 w-1/2 cursor-pointer">
                <img src="./facebookLogo.svg" alt="Logo de facebook" />
              </button>
            </div>
            <p>Ou</p>
            ...
            <Button
              link="/"
              fullWidth
              text="Etablir la liaison"
              className="flex justify-center cursor-pointer"
            />
            <p className="text-xs">
              Vous n'avez pas de compte ?{" "}
              <Link to="/register" className="font-bold text-xs">
                Inscription
              </Link>
            </p>
          </Formulaire>
